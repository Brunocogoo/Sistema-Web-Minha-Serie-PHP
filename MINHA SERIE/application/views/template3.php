        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav ">
                    ...
                    <li class="dropdown ">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">MINHAS <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo base_url()?>MinhasController/assistindo">Assistindo</a></li>
                            <li><a href="<?php echo base_url()?>MinhasController/assistidas">Assistidas</a></li>
                            <li><a href="<?php echo base_url()?>MinhasController/desejo">Desejo</a></li>
                            <li><a href="<?php echo base_url()?>MinhasController/sugeridas">Sugeridas</a></li>

                        </ul>
                    </li>
                    <li><a href="<?php echo base_url()?>LoginController/cadastroadm">CADASTRO ADM</a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href='<?php echo base_url()?>LoginController/Deslogar'><span class="glyphicon glyphicon-log-in"></span> SAIR</a></li>
